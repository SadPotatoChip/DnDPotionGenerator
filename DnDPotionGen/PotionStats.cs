...
namespace DnDPotionGen {
    public static class PotionStats {
        public static List<string> Title = new List<string> {
            "Potion", "Elixir", "Draught", "Vial", "Philter", "Tonic", "Brew", "Ichor", "Juice", "Concoction"
        };

        public static List<(string, string)> Effect = new List<(string, string)> {
            ...
            ("Youth", " Makes the user grow some years younger."), ("Age", " Makes the user grow some years older."),
            ...
            ("Nymph Breath", " Gives water breathing."), ("Midas", " Makes the user turn things to gold."),
            ...
            ("Sex Change", " Changes the users gender."), ("Race Change", " Changes the users race."),
            ...
            ("Godly form", " Improves all stats."), ("Bless Weapon", " Makes the users weapons do more damage."),
            ...
            ("Fear", " Makes the user terrified."), ("Night vision", " Gives the ability to see in the dark."),
            ("Tracking", " Lets the user track an enemy."), ("Cure-all", " Cures any status effects."),
        };

        public static List<string> Strength = new List<string> {
            "Regular with a slight side effect.", "Regular with no side effect.", "Regular with a strong side effect.",
        ...
        public static List<string> SideEffects = new List<string> {
            "Nothing bad at all!", "Puts the user to sleep.", "Rapid hair growth all over the body.",
            "Bleeding from the eyes.", "Vivid hallucinations.", "Flashbacks of your own eventual demise.",
            "The skin to crack and appear distorted.", "Spots to grow on the skin.", "Diarrhoea.", "Vomiting.",
            "Blurred Vision.", "Blindness.", "Deafness.", "Mutism.", "Health loss via rapid bleeding.",
            ...
            "Stunning.", "Immobilisation.", "Increased libido.", "Fidgeting.", "Itchiness.", "Rashes.",
            "Attracts bears.", "Magically covers in dirt.", "Horrifying stench.", "Baldness.", "Swelling.",
            "Loss of a random item.", "Curses.", "Damage.", "Weakness to a magical damage type.",
            "Weakness to physical damage.", "Feelings of Guilt", "Feelings of Anxiety.", "Feelings of Shame.",
            "Sneezing.", "Uncontrollable crying.", "Need to sing heroic music.", "Urge to hug.", "Kleptomania.",
            "Burping.", "Loss of smell.", "Insomnia.", "Paranoia.", "Bad luck.", "Summons imps that want to kill you.",
            "Summons angry bees.", "Fear of something.", "Temporary madness.", "Relaxation.",
            "Appreciation of colours and sound.", "Tripping the hell out.", "Painful lust.", "Light headedness.",
            "Increased confidence.", "Recklessness.", "Rage.", "Sadness.", "Dizziness.", "Pain.", "Slight possession.",
            "Allergic reaction to your favourite food.", "Strong believe you’re someone else.", "Severe debt.",
            "Grumpiness.", "Muscle spasms.", "A bloated feeling.", "A cold.", "A fever.", "Becoming strangely light.",
            "Weakness.", "The urge to fight.", "The need to make friends.", "Nausea.", "Mood swings.", "Addiction.",
            "Need for booze.", "Drunkeness.", "Coughing.", "Uncontrollable babbling.", "Slight aches.",
            "A bad taste for some time.", "Giddiness.", "Laughter.",
        };

        public static List<string> Container = new List<string> {
            " conical smooth glass bottle.", "A square glass bottle.", "A not quite watertight leather waterskin.",
            "A stone flask.", "A metal thermos.", "A glass syringe.", "A small medical vial.",
            "A small shot sized bottle.", "A large metal bottle.", "A capped horn.",
            "An ornate very decorated glass bottle.", "A geometric diamond shaped bottle.",
            "A translucent long wine bottle.", "A translucent beer bottle.", "A leather pouch.",
            "An inhaler like spray bottle.", "A coloured bottle.", "A bone flask.", "A small metal vial.",
            "A large bottle that can be swigged several times.",
        };

        public static List<string> Appearance = new List<string> {
            "Clear.", "Blue.", "Green.", "Red.", "Pale Green.", "Pink.", "Light Blue.", "White.", "Black.",
            "Dark Grey.", "Light grey.", "Yellow.", "Orange.", "Gold.", "Orange.", "Bronze.", "Metallic.", "Purple.",
            "Brown.", "Dark Red.",
        };

        public static List<string> Appearance2 = new List<string> {
            ...
            "Blood within it.", "Dirt floating in it.", "Chunks of metal in it.",
            "Some type of gore from a slain creature.", "Steam coming from it.", "A face in the liquid.",
            "Constantly moving and shifting liquid.", "A constant heat.",
        };

        public static List<string> Texture = new List<string> {
            "Thick and sludgy.", "Thin and watery.", "Airy and bubbly.", "Slimey.", "Almost solid.", "Oily.", "Chunky.",
            "Bitty.", "Milky.", "Almost gaseous.",
        };

        public static List<string> TasteSmell = new List<string> {
            "Nothing at all.", "Sulphur.", "Fresh air.", "Baking cookies.", "Flowers.", "Rotting meat.", "Egg.",
            ...
            "Garbage.", "Sand.", "The Forest.", "Nuts.", "Acidic.", "Spicy.", "Minty.", "Of chemicals.", "Dirt.",
            "Of something bad flavoured to taste better.", "Alcohol.", "Sugar.", "A damp cave.", "Strange.",
            "Indescribable but nice.", "Indescribable but horrid.", "Rain.", "Medical.", "Bacon.", "Coffee.",
            "Cut grass.", "Vanilla.", "The sea.", "Roast meat.", "Festive.", "Lavender.", "Lilac and Gooseberries.",
            "A fresh baby.", "A new car.", "Cirtrus.", "Leather.", "Metal.", "A forge.", "Fresh Cake.", "Paint.",
            "Wine.", "Polish.", "Cheese.", "Fish.", "Compost.", "The sewers.", "Apples.", "Holy oils.", "Massage oil.",
            "A brothel.", "Old fruit.", "Roses.", "Something that stirs memories.", "Gingerbread.", "Cinnamon.",
            "Candy.", "Fumes.", "Bark.", "Chicken.", "Beef.", "Human Flesh.", "Gunpowder.", "A storm.", "Success.",
            "Gold.", "Mayonnaise.", "Barbeque.", "Salt.", "Pepper.", "Aromatic spices.", "Fruit punch.", "Water.",
            "Fresh water.", "Stagnant water.", "Mud.", "A colour.", "Music.", "The end of the world.",
        ...
        public static List<string> Label = new List<string> {
            ...
            "Its description in elvish with a relevant mythic story.", "Its description on dwarven.", "Dwarven runes.",
            ...
            "Doesn’t seem to have one.", "Its description and a random fact.",
            "Its description and a small compliment to make your day better.", "Its description and a joke.",
            "Its description in infernal.", "Its description in some ancient language.", "All in some kind of symbols.",
            "All in some kind of raised symbols for the blind to read.", "Its description in elemental languages.",
            "Its name and flavour.", "Its name with a warning about side effects.",
            "Its name and its recommended buying price.", "Bloody prints all over it.",
            "Name engraved into the container.", "Its name glowing with minor magic.", "A cartoony mascot.",
            "A warning of an ancient curse.", "Its name and description in invisible ink.",
            "Its description in draconic.", "Several different names and descriptions plastered over eachother.",
            ...
            "A persons name. The potion wont work unless asked by its name to do so.", "A strange prophecy.",
            "A small doodle.", "A note saying DO NOT DRINK.",
            ...
            "Its description in Deep speech.", "Its description in strange arcane symbols.",
            "A map of where the potion was made.", "A small puzzle for kids.",
            ...
            "A happy face.", "A healing symbol.", "A cheesy pun potion name.", "Growing with vines.",
            "Growing with flowers.", "Growing with crystals.", "Growing with rock.",
            "Shamanistic symbols and shavings.", "No words just a single colour.",
            "Water damage but a just legibale label.", "A label as if it was some kind of present.",
